...
# @File        : lgcm_dataset.py
# @Description :


"""
suppose encoder's input is (x_1, y_1, ..., x_t), decoder's input is y_t
+ Encoder:
    + Sequence:           <bos>   x_1 <eos>   <bos> y_1 <eos> ... <bos>   x_t <eos>
    + Type:               <human> ... <human> <bot> ... <bot> ... <human> ... <human>
    + Token Position:     0       1 ...        0    1 ...     ... 0       1 ...
    + Utterance Position: 2t-1    ...         2t-2  ...       ... 1       1 ...
+ Decoder:
...
class LGCMDataset(Dataset):
    def __init__(self, cache_data_path, vocab, max_history_utterance, max_context_seq_len, max_tgt_len):
        """
        ...
        """
        super(LGCMDataset, self).__init__()
        ...
        data = [self.build_data(dialog=dialog, vocab=vocab, max_history_utterance=max_history_utterance,
                                max_context_seq_len=max_context_seq_len, max_tgt_len=max_tgt_len)
    ...
    def build_data(self, dialog, vocab, max_history_utterance, max_context_seq_len, max_tgt_len=0):
        ...
        return {"context": context,
                "tgt": tgt,
                "context_type_ids": context_type_ids_context,
                "tgt_type_ids": tgt_type_ids,
                "context_position_ids": context_position_ids_context,
                "tgt_position_ids": tgt_position_ids,
                "turn_position": turn_position_context}
